...
# set.seed(127)
# click_data <- data.frame(Day = 1:30,
#                  A = round(rnorm(30, mean = 300, sd = 120), 2),
#                  B = abs(round(rnorm(30, mean = 250, sd = 170), 2)))
# 
# 
# write.csv(click_data, "data/click_data.csv", row.names = F)
...
t.test(x = click_data$A, # first sample
       y = click_data$B,  # second sample
...
DF = 50:
```{r qt_ex1, exercise = TRUE}
qt(c(.025, .975), df = 50) %>% round(2)
```


DF = 100:
```{r qt_ex2, exercise = TRUE}
qt(c(.025, .975), df = 100) %>% round(2)
```

DF = 500:
```{r qt_ex3, exercise = TRUE}
