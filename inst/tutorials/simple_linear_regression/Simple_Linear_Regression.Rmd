...
```{r eleven, exercise = TRUE, message=F}
...
```{r fourteen, exercise = TRUE, warning=FALSE, message = F}
...
<!-- beta <- NULL -->
<!-- for(i in 1:5000){ -->
<!--   data <- sample_frac(sales, 1, replace= TRUE) -->
...
slopes <- NULL
for(i in 1:1000){
  d <- sample_frac(sales, 1, replace = TRUE)
