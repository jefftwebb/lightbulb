...
library(learnr)
knitr::opts_chunk$set(echo = FALSE, knitr.duplicate.label = "allow")
library(tidyverse)
library(ISLR)
library(janitor)
...
```{r fourteen, exercise = T, warning=FALSE, message = F}
