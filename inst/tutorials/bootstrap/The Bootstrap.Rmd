...
4. Within each loop take a bootstrap sample of the data, fit the regression, and extract and store the desired regression coefficient. You can access regression coefficients from a model with this code: `coef(model_object)`.
5.  Compute the confidence interval for the coefficient and assess statistical significance. 
